...
describe('test suite :Product',()=>{
    ...
    it('has the correct proprties',()=>{
        //now check all details of product classs but don't test all property in Product
...
describe('test suite: Clothing',()=>{
  ...
  it('check extra info Html in sizechart',()=>{
